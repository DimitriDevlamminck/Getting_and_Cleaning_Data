Description:
The work done here has been done in the context of an On-Line course on "Getting and Cleaning Data" from Johns Hopkins.

Source Data:
The source data for this project can be found at :
  https://d396qusza40orc.cloudfront.net/getdata%2Fprojectfiles%2FUCI%20HAR%20Dataset.zip
A description of the files can be found at:
